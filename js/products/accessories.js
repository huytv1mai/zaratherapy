var products = [
    { name: 'Balance Ball', price: 14, oldPrice: 18 },
    { name: 'Mini Exercise Bike', price: 45, oldPrice: 65 },
    { name: 'Muscle Stimulator', price: 49, oldPrice: 69 },
    { name: 'Dumbbell', price: 9, oldPrice: 14 },
    { name: 'Wheel Chair', price: 175, oldPrice: 195 },
    { name: 'Yoga Mat', price: 11, oldPrice: 15 },
]
